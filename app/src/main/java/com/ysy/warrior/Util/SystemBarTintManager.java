...
public class SystemBarTintManager {
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
                FrameLayout.LayoutParams.MATCH_PARENT, mConfig.getStatusBarHeight());
    ...
    public static class SystemBarConfig {
        ...
        private SystemBarConfig(Activity activity, boolean translucentStatusBar, boolean traslucentNavBar) {
            ...
            mSmallestWidthDp = getSmallestWidthDp(activity);   //获得屏幕的宽度
            mStatusBarHeight = getInternalDimensionSize(res, STATUS_BAR_HEIGHT_RES_NAME); //获得状态栏的高度
        ...
        private int getNavigationBarWidth(Context context) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                if (hasNavBar(context)) {
                    result = getInternalDimensionSize(res, NAV_BAR_WIDTH_RES_NAME);
                }
            }
            return result;
        }
        ...
        private float getSmallestWidthDp(Activity activity) {
            ...
            float widthDp = metrics.widthPixels / metrics.densityDpi;
            float heightDp = metrics.heightPixels / metrics.densityDpi;
