...
import com.ysy.warrior.activity.EditTaskActivity;
import com.ysy.warrior.adapter.MyTaskAdapter;
import com.ysy.warrior.bean.SortTask;
...
public class MyTaskFragment extends BaseFragment {
    ...
    private void initRecyclerView() {
        ...
        mRecyclerViewDragDropManager.setDraggingItemShadowDrawable(
                (NinePatchDrawable) getResources()
                        .getDrawable(R.drawable.material_shadow_z3_xxhdpi));
        ...
        if (supportsViewElevation()) {
            ...
            mRecyclerView.addItemDecoration(new ItemShadowDecorator(
                    (NinePatchDrawable) getResources().getDrawable(R.drawable.material_shadow_z1_xxhdpi)));
        }
