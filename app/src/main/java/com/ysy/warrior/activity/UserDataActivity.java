 ...
 * Time: 15:44
 */
public class UserDataActivity extends BaseActivity implements View.OnClickListener, ObservableScrollViewCallbacks, RevealBackgroundView.OnStateChangeListener {
    ...
    private void init() {
        ...
        SCROLL_DIS = getResources().getDimensionPixelSize(R.dimen.photo_top)
                - getResources().getDimensionPixelSize(R.dimen.title_height) / 2
                + getResources().getDimensionPixelSize(R.dimen.photo_size) / 2;
...
//            });
    ...
    private void titleAnim() {
        ...
        iv_photo.animate().alpha(1).translationY(0).setDuration(100).start();
