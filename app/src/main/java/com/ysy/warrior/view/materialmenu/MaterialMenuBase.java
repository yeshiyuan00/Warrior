...
import static com.ysy.warrior.view.materialmenu.MaterialMenuDrawable.DEFAULT_PRESSED_DURATION;
import static com.ysy.warrior.view.materialmenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.ysy.warrior.view.materialmenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.ysy.warrior.view.materialmenu.MaterialMenuDrawable.IconState;
...
public abstract class MaterialMenuBase implements MaterialMenu {
    ...
    /**
     * Overwrites behaviour of pressed state circle animation even when using {@link
     *
